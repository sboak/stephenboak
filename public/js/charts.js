var current = [
  ...
  level: 4,
  description: "Omnigraffle, Wireframes, Interactive Mockups. I always research and document workflows before building them."},
  {name: "Javascript",
  level: 3,
  ...
  level: 3,
  description: "Matching user needs with product requirements. Managing tickets, deadlines, and customer feedback"},
  {name: "Ruby",
  level: 2,
...
var past = [
  ...
  level: 3.5,
  description: "For 5 years I worked with some of the best built-environment engineers in the world, passed the California Engineer-in-Training (EIT) exam & almost finished my Professional Engineer (PE) certification."},
